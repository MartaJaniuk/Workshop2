...
public class UserDao {
    ...
    private static final String READ_USER_QUERY_BY_ID = "select * from workshop2.users where id = ?;";
    private static final String UPDATE_USER_QUERY = "update workshop2.users set email=?, username=?, password=? where id = ?;";
    private static final String DELETE_USER_BY_ID = "delete from workshop2.users where id = ?;";
    private static final String READ_ALL_USERS = "select * from workshop2.users;";
